...
from timezone_api_key import timezone_api_key
import timezone_api_calls
import sql_queries
...
if __name__ == '__main__':
    ...
    try:
        create_database_tables.create_timezone_table(c)
        create_database_tables.create_details_table(c)
        create_database_tables.create_error_table(c)
        conn.commit()
    except Exception as e:
    ...
    try:
        time_zone_response = timezone_api_calls.get_time_zone_list(timezone_api_key)
